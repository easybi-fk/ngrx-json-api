...
var getDenormalisedPath = function (path, baseResourceType, resourceDefinitions, pathSeparator) {
    ...
    for (var i = 0; i < fields.length; i++) {
        /** @type {?} */
        var definition = find(resourceDefinitions, { type: currentResourceType });
    ...
    if (modificationType === 'SET') {
        ...
        if (currentErrors) {
            var _loop_1 = function (currentError) {
                /** @type {?} */
                var remove = errors && errors.filter(function (it) { return isEqual(it, currentError); }).length > 0;
                if (!remove) {
...
var updateStoreDataFromPayload = function (storeData, payload) {
    /** @type {?} */
    var data = /** @type {?} */ (get(payload, 'data'));
    if (isUndefined(data)) {
        return storeData;
    }
    /** @type {?} */
    var resources = isArray(data)
        ? /** @type {?} */ (data) : /** @type {?} */ ([data]);
    /** @type {?} */
    var included = /** @type {?} */ (get(payload, 'included'));
    ...
    return filter(resources, function (resource) {
        if (query.hasOwnProperty('params') &&
            ...
            return query.params.filtering.every(function (element) {
                ...
                /** @type {?} */
                var operator = /** @type {?} */ (find(filteringOperators, {
...
function selectNgrxJson() {
    return function (state$) {
        return (/** @type {?} */ (state$)).pipe(select('NgrxJsonApi'), map(function (it) { return (it); }), filter$1(function (it) { return !isUndefined(it); }));
    };
}
/**
 * @return {?}
    ...
    return function (state$) {
        return state$.map(function (state) {
            ...
            if (isEmpty(storeQuery.resultIds)) {
                /** @type {?} */
                var queryResult = __assign$1({}, storeQuery, { data: isUndefined(storeQuery.resultIds) ? undefined : [] });
                return queryResult;
            }
            else {
                /** @type {?} */
...
function selectOneQueryResult(queryId, denormalize) {
    return function (state$) {
        return state$.map(function (state) {
            ...
            if (isEmpty(storeQuery.resultIds)) {
                /** @type {?} */
                var queryResult = __assign$1({}, storeQuery, { data: isUndefined(storeQuery.resultIds) ? undefined : null });
                return queryResult;
            }
            else {
...
var NgrxJsonApiZoneService = /** @class */ (function () {
    ...
    function (options) {
        ...
        /** @type {?} */
        var fromServer = isUndefined(options.fromServer)
            ? true
            : options.fromServer;
        if (!query.queryId) {
    ...
    function (options) {
        ...
        /** @type {?} */
        var toRemote = isUndefined(options.toRemote) ? false : options.toRemote;
        if (toRemote) {
...
var NgrxJsonApiService = /** @class */ (function (_super) {
    ...
    function (options, multi) {
        ...
        var fromServer = isUndefined(options.fromServer)
            ...
            : options.fromServer;
        /** @type {?} */
        var denormalise = isUndefined(options.denormalise)
            ? false
            : options.denormalise;
        /** @type {?} */
        var newQuery;
    ...
    function (path, resourceType) {
        /** @type {?} */
        var pathSeparator = /** @type {?} */ (get(this.config, 'filteringConfig.pathSeparator'));
...
var NgrxJsonApi = /** @class */ (function () {
    ...
    function (type) {
        /** @type {?} */
        var definition = find(this.definitions, { type: type });
        if (definition) {
        ...
        this.refreshQueriesOnDelete$ = this.actions$.pipe(ofType(NgrxJsonApiActionTypes.API_DELETE_SUCCESS), withLatestFrom(this.store, function (action, store) {
            ...
            for (var queryId in state.queries) {
                if (state.queries.hasOwnProperty(queryId)) {
                    ...
                    if (query.resultIds) {
                        /** @type {?} */
                        var needsRefresh = findIndex(query.resultIds, function (o) {
                            return isEqual(id, o);
                        }) !== -1;
                        /** @type {?} */
