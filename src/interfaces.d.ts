...
export declare type OperationType = 'GET' | 'DELETE' | 'PATCH' | 'POST' | false;
export interface OneResourceRelationship {
    data?: ResourceIdentifier;
    reference?: StoreResource;
}
export declare type ErrorModificationType = 'ADD' | 'REMOVE' | 'SET';
...
export interface ResourceDefinition {
    ...
    attributes?: {
        [key: string]: ResourceAttributeDefinition;
    };
    relationships?: {
        [key: string]: ResourceRelationDefinition;
    };
}
...
export declare type ResourceRelationType = 'hasOne' | 'hasMany';
export declare type ResourceState = 'NEW' | 'IN_SYNC' | 'CREATED' | 'UPDATED' | 'DELETED' | 'NOT_LOADED';
